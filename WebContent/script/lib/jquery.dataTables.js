...
(/** @lends <global> */function( $ ) {
	...
	function _fnCreateTr ( oSettings, iRow, nTrIn, anTds )
	{
		...
		if ( row.nTr === null )
		{
			...
			for ( i=0, iLen=oSettings.aoColumns.length ; i<iLen ; i++ )
			{
				...
				if(nTd.innerText){
                    titles.push(header[i].cell.innerText+'：'+nTd.innerText);
                }
			}
        ...
        row.nTr.setAttribute('title',titles.join('\n'));
	}
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "显示第 _START_ 条到第 _END_ 条，共 _TOTAL_ 条数据",
	...
	$.extend( DataTable.ext.classes, {
		...
		/* Filtering */
		"sFilterInput": "search-query input-small span8",
	
		/* Page length */
		"sLengthSelect": "page input-small",
	...
	$.extend( _ext.type.order, {
		...
		"time-asc": function ( x, y ) {
			var time1 = parseFloat($(x)[0].dataset.time);
			var time2 = parseFloat($(y)[0].dataset.time);
