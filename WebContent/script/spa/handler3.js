...
(function (factory) {
	 ...
	 */
	var Handler3 = function (module, modulePath, renderTo, params, context,title) {
		try{
		...
		return new Handler3.fn.init(module, modulePath, renderTo, params, context,title);
	};
	
	Handler3.AsyncEvent = function (func, time) {
		this.func = func;
		this.time = time;
		this.windowId = 0;
		this.uniqueId = 0;
	...
	Handler3.fn = Handler3.prototype = {
		 ...
		 */
		pause: function () {
			var that = app.dispatcher3.cache[this.cacheId];
			if (that) 
				that = null;

			app.dispatcher3.cache[this.cacheId] = this;
		...
		setTimeout: function(func, timeout,immediately) {
			...
			var handler = this, 
				event = new Handler3.AsyncEvent(func, timeout), 
		...
		setInterval: function (func, timespan,immediately) {
            ...
            var event = new Handler3.AsyncEvent(func, timespan),
	...
	Handler3.fn.init.prototype = Handler3.fn;
