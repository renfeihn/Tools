...
<section class="panel sql-tool-page">
	<ul class="nav nav-tabs nav-public" id="page_ul">
		<li class="active" data-skip="SQLTool#mySQLTool"><a href="#tabs1" data-toggle="tab">我的SQL工具</a></li>
		<li  data-skip="SQLTool#SQLCircle"><a href="#tabs2" data-toggle="tab">SQL圈</a></li>
	</ul>
