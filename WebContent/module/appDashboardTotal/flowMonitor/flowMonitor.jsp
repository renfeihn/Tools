...
<style>
	...
	.logCollectTM-totalApp>span:nth-child(1){
		width: 100%;
		margin-top: 0;
		background-color: #f1f0f5;
		color: #5b5a65;
	}
	.logCollectTM-totalApp>span:nth-child(2){
		margin-right: 0;
	}
	.logCollectTM-totalApp>span:BEFORE{
		content: attr(beforeContent);
		font-size: 14px;
		display: block;
	}
	
	.logCollectTM-totalApp>span:AFTER{
		content: attr(afterContent);
	}
	.logCollectTM-totalAppEcharts{
		height: 100%;
		flex: auto;
		box-sizing: border-box;
		border: 1px solid #ebebed;
...
<section class="panel" style="margin: 0;">
	...
	<div class="content">
		<div style="display: flex; margin-bottom: 20px;height: 200px;position: relative;">
			<div class="logCollectTM-totalApp">
			...
			<div class="logCollectTM-totalAppEcharts">
		...
		<section class="panel">
			...
			<div class="content" style="position: relative;">
				<div class="logCollectTM-operate" style="font-size: 12px;margin-bottom: 10px;">
					<span class="hide">视图：<span class="logCollectTrafficMonitor-radio">
