...
<section class="panel configManges" style="margin: -20px -20px 0;">
	<p class="title">JAVA配置管理</p>
	<div class="content">
		<section class="panel" style="height: 600px;">
			<p class="title" id="title">服务器列表</p>
						...
						<div class="control-group fl mb0">
							<div class="controls ml20 mb0">
								...
								<label for="radio-abs" class="control-label fz16 fr w100 m0 " style="width: 100px;">
									...
									value="ABS" checked="checked" class="configManges-radio" style="vertical-align: -3px;">
									ABS列表</label>
							</div>
						</div>
						<%--<div class="control-group fl ml50 mb0" style="margin-left: 35px;">--%>
							<%--<div class="controls  ml20">--%>
								 <%--<label for="radio-afa" class="control-label fz16 fr w100 " style="width: 100px;">--%>
									...
									<%--value="AFA" class="configManges-radio">--%>
								 	<%--AFA列表</label>--%>
							<%--</div>--%>
						<%--</div>--%>
					</form>
					<!--ABS树结构  -->
					<ul id="fileUl" class="ztree" style="height: 30px;" data-type="ABS">
					</ul>
					<%--<ul id="fileAFA" class="ztree hide" style="height: 30px;" data-type="AFA"></ul>--%>
				</div>
				<div class="panel  bnone configManges-content"
					...
					<div class="content ">
						<div class="log-content">
							<div class="instBox">
								<span id="op_type" class="btn-tip"><i class="fa fa-chevron-down" style="margin-right: 4px;"></i>
									<i style="font-style: normal;" id="operts">操作方式</i>
									<span class="hide" id="single_op">单独操作</span>
									<span class="hide" id="total_op">批量操作</span>
								</span>
								<span id="showModal" class="btn-tip"> <i class="fa fa-plus" style="margin-right: 4px;"></i>选择实例 <span>(0)</span></span>
								<div id="slides" class="hide" style="display: flex;width: 80%;margin-left:15px;">
									<span id="slideToLeft" class="hide"><i class="fa fa-angle-left" style="margin:5px 0 0 10px;"></i></span>
									<div class="slideBox">									
										<ul class="checkedBox">
											
										</ul>	
									</div>
									<span id="slideToRight" class="hide"><i class="fa fa-angle-right" style="margin:5px 0 0 10px;"></i></span>
								</div>
...
<div id="modal" class="modal hide fade w720 modalCont"
	data-backdrop="false" aria-hidden="true" tabindex="-1"
	style="width: 720px;">
	<div class="modal-header">
		<button class="close" type="button" data-dismiss="modal">×</button>
		<h3 id="myModalLabel">实例列表</h3>
	</div>
	<div class="modal-body">
		<!-- 数据表格Start -->
		<table id="dataTable_base" class="display dataTable table">
			<thead>
				<tr>
					<th><i class="fa currently all-select" id="isChangeAll"
						aria-hidden="true"></i>序号</th>
					<th class="fwb">实例编号</th>
					<th>实例名称</th>
					<th>实例类型</th>
					<th>IP地址</th>
				</tr>
	...
	<div class="modal-footer pr">
		<!-- <div class="totalNum">
			共<span id="totalNumCon"></span>条数据
		</div> -->
		<button type="button" data-dismiss="modal" class="cancelBtn">取消</button>
		<button type="button" data-dismiss="modal" class="btn confirmBtn disabled" id="confmBtn">确定</button>
	</div>
</div>