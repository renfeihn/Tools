...
/************************************分割线******************************/
#structConfig-tab3.structConfig-tab3{
	width: 45%;
    height: 75vh;
    position: fixed;
    top: 20vh;
...
.addLogPrivate2-private #dataExample{
	margin: 0;
    margin-left: 104px;
}
</style>

<div class="addLogPrivate2-private">
	<form id="structConfig_form" class="form-horizontal structConfig-form" autocomplete="off">
		<div class="control-group">
			...
			<div class="controls">
				<select name="" id="selectApps" class="select-css" style="width: 180px;">
				</select>
			</div>
		</div>
		...
		<div class="control-group">
			<label class="control-label required">个性数据结构化</label>
			<div class="controls">
				<ul class="structConfig-structKey" style="margin-top: 20px;">
...
<div id="mask"></div>
<div class="structConfig-tab3" id="structConfig-tab3">
	...
	<div class="structConfig-slideBlockBody">
		<form class="form-horizontal structConfig-form" autocomplete="off">
			<div class="split-fields">
				<div class="control-group" style="width: 32%;float: right;">
					...
					<div class="controls">
						<select name="logType" id="fieldType" style="width: 120px;">
				...
				<div class="control-group" style="width: 33.33%;display: inline-block;">
					...
					<div class="controls">
						<input type="text" id="fieldKey" style="width: 120px;">
					</div>
				</div>
				<div class="control-group" style="width: 33.33%;display: inline-block;">
					<label class="control-label required">字段描述</label>
					<div class="controls">
						<input type="text" id="fieldDesc" style="width: 120px;">
					</div>
				</div>
			</div>
		</form>
		<div id="split-setting">
			...
			<div class="tips-json-or-xml" id="jsonOrXml" style="display: none;">
				<div class="json" style="display: none;">
					执行脚本：$.json(["contains1", "contains2", .....])<br>
					脚本说明：若LOG_EVENT包含任意一个contains,则自动解析日志中的json报文，返回map<br>
					<br>
					执行脚本：$.json(["contains1", "contains2", .....],"keyPattern")<br>
					脚本说明：若LOG_EVENT包含任意一个contains,则自动解析日志中的json报文，返回指定的key的值<br>
					<br>
					执行脚本：$.json(["contains1", "contains2", .....],["key1", "key2"])<br>
					脚本说明：若logevent包含任意一个contains,则自动解析日志中的json报文，提取指定的多个key的值，返回map<br>
				</div>
				<div class="xml" style="display: none;">
					执行脚本：$.xml(["contains1", "contains2", .....])<br>
					脚本说明：若LOG_EVENT包含任意一个contains,则自动解析日志中的json报文，返回map<br>
					<br>
					执行脚本：$.xml(["contains1", "contains2", .....],"keyPattern")<br>
					脚本说明：若LOG_EVENT包含任意一个contains,则自动解析日志中的json报文，返回指定的key的值<br>
					<br>
					执行脚本：$.xml(["contains1", "contains2", .....],["key1", "key2"])<br>
					脚本说明：若logevent包含任意一个contains,则自动解析日志中的json报文，提取指定的多个key的值，返回map<br>
				</div>
			</div>
		</div>
