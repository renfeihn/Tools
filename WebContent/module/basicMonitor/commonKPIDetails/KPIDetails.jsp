...
.KPIDetails-filter.checked {
    background: blue;
    color: white;
}
.KPIDetails-echarts-ctn .item-container {
	z-index: 300;
}
</style>
<div style="display: flex; background-color: #f1f0f5; margin-bottom: 20px; position: relative;">
	<button class="KPIDetails-filter hide" id="filter">过滤</button>
