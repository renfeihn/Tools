...
// Source File Name:   WebServiceConfigNode.java
...
public class WebServiceConfigNode extends ServiceConfigNode
{

	private int gid;
	private int mid;
	private int sid;
	private static final String OPTIONS_NAME = "wsOptions";

	public WebServiceConfigNode(byte contents[], int gid, int mid, int sid)
	...
	public WebServiceConfigNode(String configStr)
		throws AfaConfigException
	{
	...
	protected void initArea()
	{
		...
		setCores(new String[] {
			"port", "ioEventThreads", "sessionTimeout"
		});
	}

	public Element getElement()
	{
		return getElementByXPath(ConfigFileXPath.lsrServiceOptions(gid, mid, sid, "wsOptions"));
	}
	...
	public Document createDocumentFromPageJson(String serviceName, JSONObject pageJson)
	{
		...
		Element optionsEle = root.addElement("wsOptions");
