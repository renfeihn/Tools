...
// Source File Name:   AFTServiceConfigNode.java
...
public class AFTServiceConfigNode extends ServiceConfigNode
{

	private int gid;
	private int mid;
	private int sid;
	private static final String OPTIONS_NAME = "aftOptions";

	public AFTServiceConfigNode(byte contents[], int gid, int mid, int sid)
	...
	public AFTServiceConfigNode(String configStr)
		throws AfaConfigException
	{
	...
	protected void initArea()
	{
		...
		setCores(new String[] {
			"port", "ioEventThreads", "readTimeout", "baseDir", "maxDirDepth", "maxFileNameLength", "maxUploadFileSize", "maxDownloadFileSize", "overrideIfExist", "makeDirIfAbsent"
		});
	}

	public Element getElement()
	{
		return getElementByXPath(ConfigFileXPath.lsrServiceOptions(gid, mid, sid, "aftOptions"));
	}
	...
	public Document createDocumentFromPageJson(String serviceName, JSONObject pageJson)
	{
		...
		Element optionsEle = root.addElement("aftOptions");
