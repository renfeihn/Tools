...
// Source File Name:   AsyncSocketServiceConfigNode.java
...
public class AsyncSocketServiceConfigNode extends ServiceConfigNode
{

	private int gid;
	private int mid;
	private int sid;
	private static final String OPTIONS_NAME = "asyncSocketOptions";

	public AsyncSocketServiceConfigNode(byte contents[], int gid, int mid, int sid)
	...
	public AsyncSocketServiceConfigNode(String configStr)
		throws AfaConfigException
	{
	...
	{
		return getElementByXPath(ConfigFileXPath.outServiceOptions(gid, mid, sid, "asyncSocketOptions"));
	}
	...
	public Document createDocumentFromPageJson(String serviceName, JSONObject pageJson)
	{
		...
		Element optionsEle = root.addElement("asyncSocketOptions");
