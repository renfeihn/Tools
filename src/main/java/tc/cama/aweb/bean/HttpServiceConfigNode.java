...
// Source File Name:   HttpServiceConfigNode.java
...
public class HttpServiceConfigNode extends ServiceConfigNode
{
	...
	private static final String OPTIONS_NAME = "httpOptions";
	private static final String FLOWCONTROL = "flowControl";
	private static Map xpathMap;

	public HttpServiceConfigNode(byte contents[], int gid, int mid, int sid)
	...
	public HttpServiceConfigNode(String configStr)
		throws AfaConfigException
	{
	...
	protected void initArea()
	{
		...
		setCores(new String[] {
			"port", "ioEventThreads", "resourceRoot", "syncAsyncMode", "sessionTimeout"
		});
		setLists(new String[] {
			"ssl"
		});
	...
	public Element getElement()
		throws AfaConfigException
	{
		return getElementByXPath(ConfigFileXPath.lsrServiceOptions(gid, mid, sid, "httpOptions"));
	}
	...
	public Document createDocumentFromPageJson(String serviceName, JSONObject pageJson)
	{
		...
		Element optionsEle = root.addElement("httpOptions");
