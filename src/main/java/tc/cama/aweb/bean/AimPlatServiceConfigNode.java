...
// Source File Name:   AimPlatServiceConfigNode.java
...
public class AimPlatServiceConfigNode extends ServiceConfigNode
{

	private int gid;
	private int mid;
	private int sid;
	private static final String OPTIONS_NAME = "aimPlatOptions";

	public AimPlatServiceConfigNode(byte contents[], int gid, int mid, int sid)
	...
	public AimPlatServiceConfigNode(String configStr)
		throws AfaConfigException
	{
	...
	protected void initArea()
	{
		...
		setCores(new String[] {
			"ioEventThreads", "port", "devName", "hostedAgents", "deployBasePath"
		});
	}
	...
	public Element getElement()
		throws AfaConfigException
	{
		return getElementByXPath(ConfigFileXPath.lsrServiceOptions(gid, mid, sid, "aimPlatOptions"));
	}
	...
	public Document createDocumentFromPageJson(String serviceName, JSONObject pageJson)
	{
		...
		Element optionsEle = root.addElement("aimPlatOptions");
