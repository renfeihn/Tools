...
// Source File Name:   ReplyServiceConfigNode.java
...
public class ReplyServiceConfigNode extends ServiceConfigNode
{

	private int gid;
	private int mid;
	private int sid;
	private static final String OPTIONS_NAME = "replyOptions";

	public ReplyServiceConfigNode(byte contents[], int gid, int mid, int sid)
	...
	public ReplyServiceConfigNode(String configStr)
		throws AfaConfigException
	{
	...
	{
		return getElementByXPath(ConfigFileXPath.lsrServiceOptions(gid, mid, sid, "replyOptions"));
	}
	...
	public Document createDocumentFromPageJson(String serviceName, JSONObject pageJson)
	{
		...
		Element optionsEle = root.addElement("replyOptions");
