...
@Entity
@Table(name = "aim_esb_mon_msext_his")
public class AimEsbMonMsextHis implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 7701112617911594424L;
	/**
	 * ID
	 */
	@Id
...
public Double  
	...
	getDayTotnum(){return this.dayTotnum;}

/**
 *@param dayTotnum 日交易量
*/
@Column(name = "day_totnum")
public void setDayTotnum(Double   dayTotnum) {this.dayTotnum = dayTotnum;}
...
public Double  
	...
	getDaySysSuccNum(){return this.daySysSuccNum;}

/**
 *@param daySysSuccNum 日系统成功笔数
*/
@Column(name = "day_sys_succ_num")
public void setDaySysSuccNum(Double   daySysSuccNum) {this.daySysSuccNum = daySysSuccNum;}
...
public Double  
	...
	getDaySysErrNum(){return this.daySysErrNum;}

/**
 *@param daySysErrNum 日系统错误笔数
*/
@Column(name = "day_sys_err_num")
public void setDaySysErrNum(Double   daySysErrNum) {this.daySysErrNum = daySysErrNum;}
...
public Double  
	...
	getDayBussSuccNum(){return this.dayBussSuccNum;}

/**
 *@param dayBussSuccNum 日业务成功笔数
*/
@Column(name = "day_buss_succ_num")
public void setDayBussSuccNum(Double   dayBussSuccNum) {this.dayBussSuccNum = dayBussSuccNum;}
...
public Double  
	...
	getDayBussErrNum(){return this.dayBussErrNum;}
...
public Double  
	...
	getDaySysRate(){return this.daySysRate;}
...
public Double  
	...
	getDayBussRate(){return this.dayBussRate;}
...
public Double  
	...
	getDayTransAvgtime(){return this.dayTransAvgtime;}
...
public Double  
	...
	getDayEsbAvgtime(){return this.dayEsbAvgtime;}
...
public Double  
	...
	getDayExpt(){return this.dayExpt;}
...
public Double  
	...
	getStopHoldTime(){return this.stopHoldTime;}
...
public Double  
	...
	getConsThreadNum(){return this.consThreadNum;}
...
public Double  
	...
	getPrvdThreadNum(){return this.prvdThreadNum;}
