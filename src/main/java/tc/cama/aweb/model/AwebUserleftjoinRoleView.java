...
@Entity
@Table(name = "aweb_userleftjoin_role_view")
public class AwebUserleftjoinRoleView implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1591582304739578734L;
	/**
	 * ID
	 */
	@Column(name = "id")
