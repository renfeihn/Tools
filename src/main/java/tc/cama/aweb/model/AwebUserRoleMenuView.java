...
@Entity
@Table(name = "aweb_user_role_menu_view")
public class AwebUserRoleMenuView implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -4966801777490671672L;
	/**
	 * 用户名
	 */
