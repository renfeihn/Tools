...
public class Objects {
	 ...
	 * NullPointerException} may or may not be thrown depending on what ordering
	...
	public static String ifEmpty(String str, String defaultVal) {
